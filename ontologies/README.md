...
*   **`src/application/`**: Application-specific ontologies. These are highly tailored to specific business use cases and inherit from the `core` and `domain` models. *Example: `app_demo.ttl` (Project -> Experiment -> Formulation).*
