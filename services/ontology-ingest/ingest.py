...
if __name__ == "__main__":
    ...
    parser.add_argument("--version-info", default="Unknown Version", help="Version metadata (e.g. Git commit SHA)")
    
    args = parser.parse_args()
    ingest_ontology(args.owl, args.project, args.dataset, args.version_info)
